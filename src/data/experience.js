const experience = [
  {
    role: "AI Data & Quality Assurance Engineer (Freelance)",
    ...
    points: [
      ...
      "Applied structured evaluation rubrics to improve model reasoning quality and response reliability.",
      "Contributed to improving alignment quality and reducing unsafe or low-quality generations in deployed models."
    ]
  },
  {
    ...
    points: [
      ...
      "Collaborated with maintainers to improve code quality and follow open-source contribution standards.",
      "Gained hands-on experience with production-level code and collaborative development practices."
    ]
  }
];
